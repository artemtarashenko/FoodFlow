...
from recepts.models import Dimensions, Ingredients, IngredientsBlacklist, ResipesDislikes, ResipesIngredients, Resipes, ResipesLikes, Steps, Marinades, Sauces
...
admin.site.register(ResipesLikes)
admin.site.register(ResipesDislikes)
admin.site.register(IngredientsBlacklist)